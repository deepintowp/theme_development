...
<head>
	<link rel="icon" href="<?php if(!empty($themeone['favicon-img'])){echo $themeone['favicon-img']['url']; } ?>" type="image/x-icon"/>
...
<body id="page-top" class="index">
    ...
    <!-- Header -->
    <header class="" <?php if($themeone['banner-img']): ?> style="<?php echo 'background-image: url('.$themeone['banner-img']['url'].')'; ?>"  <?php endif; ?> >
        <div class="container">
